...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 10 mai 2021 à 07:08
...
(3, '  Rf2554', '  Le pelerin  ', '2021-04-06', '  Paulo Coelho', ' Roman', ' Santiago, un jeune berger andalou, part Ã  la recherche d\'un trÃ©sor enfoui au pied des Pyramides.\r\n\r\nLorsqu\'il rencontre l\'Alchimiste dans le dÃ©sert, celui-ci lui apprend Ã  Ã©couter son cÅ“ur, Ã  lire les signes du destin et, par-dessus tout, Ã  aller au bout de son rÃªve.', 10, '1.jpg', 25, 3),
(11, 'FR2017', 'Pirate', '2021-05-09', 'franck', 'Revue Critique', ' aezrtyioiitrgfhgdsgdgfhkhdrs', 9, '5.jpg', 9000000, NULL),
...
(53, 6, 'DESKTOP-SRHP1GT', 4),
(54, 3, 'DESKTOP-SRHP1GT', 3);
...
(15, 'Saison blange et séche', 'qqsdfghjkl', 'zzzzz', 'azaee', 10, 96, 78, '');
...
INSERT INTO `reference` (`ID`, `id_livre`, `id_client`, `note`) VALUES
(51, 7, '191JFT4357', 5),
(52, 5, 'DESKTOP-6320O01', 5);
