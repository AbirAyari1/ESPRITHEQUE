      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><img src="img/avatar-7.jpg" alt="person" class="img-fluid rounded-circle">
            <h2 class="h5">Esprithèque</h2><span>Espace event</span>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li ><a href="../views/admin/forms.php"> <i class="icon-user"></i>Etudiants</a></li>
            ...
            <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i
                  ...
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                      ...
                      <li><a href="../views/admin/categories.php">Categories</a></li>
              ...
              <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i
                  ...
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                      <li class="active" ><a href="../views/afficherparticipant.php"> <i class="icon-check"></i>Participants</a></li>
                      <li><a href="../views/admin/evenements.php">evenement</a></li>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li><a rel="nofollow" href="#" class="dropdown-item all-notifications text-center"> <strong> <i class="fa fa-list"></i> Voir tous les détails</strong></a></li>
                  </ul>
                </li>
