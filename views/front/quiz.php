...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="quiz.php?q=1"><span class="glyphiconn glyphiconn-home" aria-hidden="true"></span>&nbsp;Home<span class="sr-only">(current)</span></a></li>
            <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>> <a href="quiz.php?q=2"><span class="glyphiconn glyphiconn-list-alt" aria-hidden="true"></span>&nbsp;History</a></li>
            <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>> <a href="quiz.php?q=3"><span class="glyphiconn glyphiconn-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li>
