  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/etudiant.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>Partie cours.</h3>
            <p class="fst-italic">
              Espritheque offre la possibilité aux étudiants de trouver tous les cours pour faciliter l'education en ligne 
             
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> voir tous des cours disponibles  .</li>
              <li><i class="ri-check-double-line"></i> Téléchargement des cours  .</li>
              <li><i class="ri-check-double-line"></i> faire des quiz pour tester vos limites</li>
            </ul>
    ...
    <section id="features" class="features">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="image col-lg-6" style='background-image: url("assets/img/cours.jpg");' data-aos="fade-right">
          </div>
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">
            <div class="icon-box mt-5 mt-lg-0" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-receipt"></i>
              <h4>Utilisation facile</h4>
              <p>ESPRITHEQUE permet de mettre à disposition des usagers une visionneuse au design ergonomique afin qu'ils puissent consulter facilement, directement dans le portail, divers documents numériques</p>
            </div>
            <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-cube-alt"></i>
              <h4>Suivi d'activité</h4>
              <p>Pour répondre aux besoins de leurs étudiants,professeur et managers de l'information ont besoin de comprendre leurs comportements,Pour cela, ESPRITHEQUE intègre divers outils statistiques évaluant aussi bien l'activité d'une structure que l'efficacité d'une campagne d'e-mailings</p>
            </div>
            <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-images"></i>
              <h4>Interopérabilité</h4>
              <p>ESPRITHEQUE est flexible et doté de nombreuses fonctionnalités pour que les catalogues soient toujours enrichis de différentes façons et les plus visibles possibles</p>
            </div>
            <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-shield"></i>
              <h4>Sécurité</h4>
              <p>Les produits de la numérisation doivent aussi être préservés, comme les documents numérisés
                d’origine. Tous les projets d'ESPRITHEQUE doivent inclure des plans pour la préservation
                numérique par les autorités compétentes</p>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <p>App</p>
                  <div class="portfolio-links">
                    <a href="img/portfolio/port3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 2"><i class="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch" data-aos="fade-left"
            ...
            <div class="content d-flex flex-column justify-content-center">
              <h3>Offrir du plaisir comme méritant</h3>
              ...
              <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>clients satisfaits</strong> nous avons toujours  le plaisir de vous servir.</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="30" data-purecounter-duration="2"
                      class="purecounter"></span>
                    <p><strong>Projects</strong> Plein d'autre futur projets mais notre premier projet ESPRITHEQUE est un succés
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="2" data-purecounter-duration="4"
                      class="purecounter"></span>
                    <p><strong>Années d'experience</strong> on a passé 2 ans à chercher la creativité pour un meilleur futur</p>
                  </div>
                </div>
