...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
        ...
        <h1 class="logo me-auto me-lg-0"><a href="index.html">Ep<span>.</span></a></h1>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-info">
                        ...
                        <ul>
                            ...
                            <li><strong>Prix </strong>: <?php echo $row["prix"]; ?> EU</li>
...
<footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>Ep</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
