    ...
    <div class="page">
      ...
      <section class="forms">
        <div class="container-fluid">
          ...
          <form name="f1" method="POST" onsubmit="return verif()"action="updatefunQ.php" >
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="que" id="que"  value="<?php echo $que; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="option1" id="option1" value="<?php echo $option1; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>option 2 </label>
                                                    <input class="form-control" name="option2" id="option2" value="<?php echo $option2; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>option 3 </label>
                                                    <input class="form-control" name="option3" id="option3" value="<?php echo $option3; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>option 4 </label>
                                                    <input class="form-control" name="option4" id="option4" value="<?php echo $option4; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>answer </label>
                                                    <input class="form-control" name="ans" id="ans" value="<?php echo $ans; ?>">
                                                </div>
                                            </div>
                                               <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>user answer </label>
                                                    <input class="form-control" name="userans" id="userans" value="<?php echo $userans; ?>">
                                                </div>
                                            </div>
