...
if(isset($_POST['id']) and  isset($_POST['matiere']) and isset($_POST['titre'])  and isset($_POST['annee']) )
{
	$errors=[] ; 
	if (empty($_POST['id'])) {
	...
	if (empty($_POST['annee'])) {
		$errors['annee']='annee obligatoire' ; 
	}


	if (empty($errors)){
		
	$cours= new cours( $_POST['id'],$_POST['matiere'],$_POST['titre'],$_POST['annee']);
	$coursC=new coursC();
