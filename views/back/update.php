      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="ajout.php"> <i class="icon-grid"></i>Tables                             </a></li>
        ...
        <div class="admin-menu">
          ...
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
            <li> <a href="ajout.php"> <i class="icon-screen"> </i>Ajout cours</a></li>
                                    ...
                                    <p>UPDATE</p>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Titre</label>
                                                    <input class="form-control" name="titre" id="titre" value="<?php echo $titre; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Matiere</label>
                                                    <input class="form-control" name="matiere" id="matiere" value="<?php echo $matiere; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="annee" id="annee" value="<?php echo $annee; ?>" 
                                            >
                                        </textarea>
