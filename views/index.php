  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
          ...
          <li><a class="nav-link scrollto" href="Evenements.php">Evènements</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              ...
              <p>Posez vos questions si vous êtes bloqués sur un code ou n'importe quelle autre question qui ont un rapport avec ce sujet.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-world"></i></div>
              <h4><a href="details-forumRevision.php">Révisions</a></h4>
              <p>Des questions par rapport à des exercices de révisions tels que les TDs.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Tout autre questions qui non rien à voir avec ces précèdents sujets.</p>
            </div>
          </div>
